    ...
    <div class="max-w-screen-xl mx-auto grid grid-cols-12 gap-4 md:gap-4 px-4 items-center">
      ...
      <div class="col-span-12 md:col-span-4 bg-secondary rounded-3xl p-4 md:p-8 flex flex-col gap-1 h-full justify-between">
        ...
        <div class="flex flex-col gap-4">
          ...
          <button class="bg-primary text-white px-4 py-2 rounded-lg w-fit flex items-center gap-2">
            Ürünü İncele
            <Icon name="uil:arrow-right" class="w-5 h-5 text-white" />
          </button>

          <p class="text-xs text-gray-500">100×120cm Tek Kullanımlık Masa ve Aktivite Örtüsü</p>
        </div>
      </div>
