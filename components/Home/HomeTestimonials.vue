    ...
    <div class="max-w-screen-xl mx-auto">
      <div class="flex flex-col items-start justify-between mb-10 md:flex-row md:items-center">
        ...
        <div class="mt-4 md:mt-0">
          <BaseButton label="Hakkımızda →" type="primary" to="/hakkimizda"/>
        </div>
      </div>

      <Swiper ref="testimonialSwiper" :modules="[Autoplay, Navigation]" :slides-per-view="1" :loop="true"
        :autoplay="{ delay: 5000, disableOnInteraction: false }" :navigation="{
          nextEl: '.custom-swiper-next',
          prevEl: '.custom-swiper-prev',
        }" class="overflow-hidden rounded-xl" @swiper="onSwiperInit">
        <SwiperSlide>
          <div class="flex flex-col items-stretch gap-0 overflow-hidden bg-secondary md:flex-row rounded-xl">
            <div class="flex-1 p-10">
              ...
              <div class="flex items-center mt-4 space-x-2 text-lg text-yellow-500">
                <span>★★★★★</span>
              </div>
              <div class="mt-2">
            ...
            <div class="flex-1">
              <NuxtImg src="/images/testimonials-1.png" alt="Müşteri yorumu" width="800" height="600"
        ...
        <SwiperSlide>
          <div class="flex flex-col items-stretch gap-0 overflow-hidden bg-secondary md:flex-row rounded-3xl">
            <div class="flex-1 p-10">
              <p class="text-xl font-semibold leading-relaxed text-gray-800">
